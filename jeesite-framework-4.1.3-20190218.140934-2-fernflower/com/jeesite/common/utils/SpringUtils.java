...
public class SpringUtils implements ApplicationContextAware, DisposableBean {	
   ...
   public static File getLicFile(String licName) {	
      ...
      label18: {	
         try {	
            a = ResourceUtils.getResourceLoader().getResource("/").getFile().getParentFile().getPath();	
   ...
   public static void clearHolder() {	
      if (logger.isDebugEnabled()) {	
         logger.debug((new StringBuilder()).insert(0, "Cear AppicationContext:").append(applicationContext).toString());	
      }	
   ...
   public static InputStream getInputStream() throws IOException {	
      ...
      if ((a = getLicFile("jeesite.lic")).exists()) {	
         ...
         Resource a;	
         if ((a = ResourceUtils.getResource("jeesite.lic")).exists()) {	
            try {	
