...
"s5X'i#,r"), "true");	
         a = this.G.getString("scrawlPathFormat");	
         break;	
      case 3:	
         var10000 = a;	
         a.put(PrintfFormat.ALLATORIxDEMO("+{>I/`#"), this.G.getLong("videoMaxSize"));	
         a.put(PrintfFormat.ALLATORIxDEMO("{*v)m\u0000s*\u007f5"), this.ALLATORIxDEMO("videoAllowFiles"));	
         a.put(PrintfFormat.ALLATORIxDEMO(" s#v\"T'w#"), this.G.getString("videoFieldName"));	
         a = this.G.getString(PrintfFormat.ALLATORIxDEMO("0s\"\u007f)J'n.\\)h+{2"));	
         break;	
      case 4:	
         var10000 = a;	
         a.put(PrintfFormat.ALLATORIxDEMO("s5X'i#,r"), "false");	
         a.put("maxSize", this.G.getLong(PrintfFormat.ALLATORIxDEMO(" s*\u007f\u000b{>I/`#")));	
         a.put("allowFiles", this.ALLATORIxDEMO(PrintfFormat.ALLATORIxDEMO("|/v#[*v)m\u0000s*\u007f5")));	
         a.put("fieldName", this.G.getString(PrintfFormat.ALLATORIxDEMO(" s*\u007f\u0000s#v\"T'w#")));	
         a = this.G.getString("filePathFormat");	
         break;	
      case 5:	
         var10000 = a;	
         a.put(PrintfFormat.ALLATORIxDEMO("|/v#t'w#"), "remote");	
         a.put("filter", this.ALLATORIxDEMO(PrintfFormat.ALLATORIxDEMO("y'n%r#h\nu%{*^)w's(")));	
         a.put("maxSize", this.G.getLong(PrintfFormat.ALLATORIxDEMO("y'n%r#h\u000b{>I/`#")));	
         a.put("allowFiles", this.ALLATORIxDEMO(PrintfFormat.ALLATORIxDEMO("%{2y.\u007f4[*v)m\u0000s*\u007f5")));	
         a.put("fieldName", (new StringBuilder()).insert(0, this.G.getString(PrintfFormat.ALLATORIxDEMO("y'n%r#h\u0000s#v\"T'w#"))).append("[]").toString());	
         a = this.G.getString(PrintfFormat.ALLATORIxDEMO("%{2y.\u007f4J'n.\\)h+{2"));	
         break;	
      case 6:	
         a.put("allowFiles", this.ALLATORIxDEMO(PrintfFormat.ALLATORIxDEMO(" s*\u007f\u000b{({!\u007f4[*v)m\u0000s*\u007f5")));	
         a.put("dir", this.G.getString(PrintfFormat.ALLATORIxDEMO(" s*\u007f\u000b{({!\u007f4V/i2J'n.")));	
         a.put("count", this.G.getInt(PrintfFormat.ALLATORIxDEMO(" s*\u007f\u000b{({!\u007f4V/i2I/`#")));	
      default:	
         var10000 = a;	
         break;	
      case 7:	
