...
public class JobEntity extends DataEntity {	
   ...
   public JobEntity convert(Scheduler scheduler, CronTriggerImpl trigger) {	
      ...
      this.setInvokeTarget((String)trigger.getJobDataMap().get(e.ALLATORIxDEMO("u\u0006j\u0007w\rH\tn\u000fy\u001c")));	
      ...
      this.setRemarks((String)trigger.getJobDataMap().get(e.ALLATORIxDEMO("\u001ay\u0005}\u001aw\u001b")));	
