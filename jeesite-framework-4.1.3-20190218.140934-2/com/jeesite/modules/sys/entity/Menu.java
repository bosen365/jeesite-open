...
public class Menu extends TreeEntity {	
   ...
   public static final Integer SUPER_ADMIN_GET_MENU_MIN_WEIGHT = Global.getPropertyToInteger("user.superAdminGetMenuMinWeight", E.ALLATORIxDEMO("PC"));	
   ...
   public Integer getWeight_lt() {	
      return (Integer)this.sqlMap.getWhere().getValue(E.ALLATORIxDEMO("\u0013\u0016\r\u0014\f\u0007"), QueryType.LT);	
   }	
   ...
   public String getMenuUrl() {	
      ...
      if (StringUtils.isBlank(a = this.getMenuHref())) {	
         ...
         String[] a;	
         if ((a = StringUtils.substringsBetween(this.getMenuHref(), E.ALLATORIxDEMO("\b"), "}")) != null) {	
            String[] var3 = a;	
            int var4 = a.length;	
            ...
            for(int var10000 = var5 = 0; var10000 < var4; var10000 = var5) {	
               String a = var3[var5];	
               if (E.ALLATORIxDEMO("\u0017\u0000\u000b'\u000b\u0018\u0001\u001d").equals(a)) {	
                  String a;	
                  String a = UserUtils.getSsoToken(a = UserUtils.getUser().getLoginCode());	
                  a = StringUtils.replace(a, "{" + a + E.ALLATORIxDEMO("\u000e"), (new StringBuilder()).insert(0, a).append("/").append(a).toString());	
               } else if (E.ALLATORIxDEMO("\u0011\u0000\u0001\u0001'\u001c\u0000\u0016").equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, "{").append(a).append(E.ALLATORIxDEMO("\u000e")).toString(), this.getCurrentUser().getUserCode());	
               } else if ("userName".equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, E.ALLATORIxDEMO("\b")).append(a).append("}").toString(), this.getCurrentUser().getUserName());	
               } else if (E.ALLATORIxDEMO("\u0011\u0000\u0001\u00010\n\u0014\u0016").equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, "{").append(a).append(E.ALLATORIxDEMO("\u000e")).toString(), this.getCurrentUser().getUserType());	
               } else if ("menuCode".equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, E.ALLATORIxDEMO("\b")).append(a).append("}").toString(), this.getMenuCode());	
               } else if (E.ALLATORIxDEMO("\t\u0016\n\u00064\u0012\u0016\u0016\n\u0007'\u001c\u0000\u0016").equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, "{").append(a).append(E.ALLATORIxDEMO("\u000e")).toString(), this.getParentCode());	
               } else if ("menuParentCodes".equals(a)) {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, E.ALLATORIxDEMO("\b")).append(a).append("}").toString(), this.getParentCodes());	
               } else {	
                  a = StringUtils.replace(a, (new StringBuilder()).insert(0, E.ALLATORIxDEMO("\b")).append(a).append("}").toString(), Global.getConfig(a));	
               }	
         ...
         if (StringUtils.startsWith(a, E.ALLATORIxDEMO("\\K\\"))) {	
            ...
            return StringUtils.startsWith(a, E.ALLATORIxDEMO("\\")) ? (new StringBuilder()).insert(0, ServletUtils.getRequest().getContextPath()).append(Global.getAdminPath()).append(a).toString() : a;	
         }	
      }	
   }	
   ...
   public void setWeight_gte(Integer weight) {	
      this.sqlMap.getWhere().and(E.ALLATORIxDEMO("\u0013\u0016\r\u0014\f\u0007"), QueryType.GTE, weight);	
   }	
}	
