...
public class User extends DataEntity {	
   ...
   public static final String SUPER_ADMIN_CODE = Global.getProperty(E.ALLATORIxDEMO("\u0006\u0017\u0016\u0016]\u0017\u0006\u0014\u0016\u00162\u0000\u001e\r\u001d'\u001c\u0000\u0016"), "system");	
   ...
   public String getAvatarUrl() {	
      if (StringUtils.isNotBlank(this.avatar)) {	
         return (new StringBuilder()).insert(0, E.ALLATORIxDEMO("K\u0010\u0010\u000b4\u0012\u0010\u001b")).append(this.avatar).toString();	
      } else {	
         ...
         return (new StringBuilder()).insert(0, a).append(E.ALLATORIxDEMO("J\u0019\u0014\u0014")).toString();	
      }	
   }	
   ...
   public void setUserDataScopeListJson(String jsonString) {	
      ...
      if ((a = (List)JsonMapper.fromJson(jsonString, List.class)) != null) {	
         ...
         while(var10000.hasNext()) {	
            ...
            a.setCtrlType((String)a.get(E.ALLATORIxDEMO("\u0007\u0007\u0016\u001f0\n\u0014\u0016")));	
