...
public class MenuController extends BaseController {	
   ...
   public String form(Menu menu, Model model) {	
      ...
      model.addAttribute(PrintfFormat.ALLATORIxDEMO("w)~3v#V/i2"), a);	
   ...
   public String list(Menu menu, Model model) {	
      ...
      return PrintfFormat.ALLATORIxDEMO("w)~3v#iii?iiw#t3V/i2");	
   }	
   ...
   public String updateTreeSort(String[] ids, Integer[] sorts) {	
      if (!UserUtils.getUser().isSuperAdmin()) {	
         return this.renderResult("false", PrintfFormat.ALLATORIxDEMO("趐朅擗会６厬朓跃纽篧琜吞扗肻俴敿歾收捴ｇ"));	
      } else {	
         int a;	
   ...
   public String fixTreeData() {	
      if (!UserUtils.getUser().isAdmin()) {	
         return this.renderResult("false", PrintfFormat.ALLATORIxDEMO("撋但奷贿ｊ台杏箻瑀呂戋胧辝衖侨夗ｇ"));	
      } else {	
   ...
   public String save(@Validated Menu menu) {	
      if (!menu.getCurrentUser().isSuperAdmin()) {	
         ...
         return this.renderResult("true", (new StringBuilder()).insert(0, "保存菜单'").append(menu.getMenuNameOrig()).append(PrintfFormat.ALLATORIxDEMO("=扖劅ｇ")).toString(), menu);	
      }	
   }	
   ...
   public String delete(Menu menu) {	
      if (!menu.getCurrentUser().isSuperAdmin()) {	
         ...
         return this.renderResult("true", PrintfFormat.ALLATORIxDEMO("剦陾莚协扖劅ｇ"));	
      }	
   }	
