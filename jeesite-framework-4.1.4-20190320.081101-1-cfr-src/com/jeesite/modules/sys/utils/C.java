 ...
 *  com.jeesite.modules.sys.utils.l	
 */	
...
import com.jeesite.modules.sys.utils.c;	
import com.jeesite.modules.sys.utils.i;	
...
public final class C {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            String[] a6 = ">>>>大牛你好，能否留个联系方式，合作QQ：78112665，暗号：Licence520<<<<`7Km/KZk46sPt7e5xmn6ZIA==``PxXhwSyYKLHQlmcx59Fl6Q==`MIGfM+0GCSqGSIb3DQEBAQU+A4GNADCBiQKBgQCePYu+/B0NP8RG3q8zXjmkYrAzcd5IMKbOkDbnwBn5dpwn1Cp0qBSpFKciUtvX3v6+HSoQW9UEVzvhOn0mgsTGArwd5dfVaR11AbPQEfxJjnI649LrjMmw4No+AO+l4LhPWu83Mk4eR4FXMWs4vIh2lmWLTMCy4mGKndsTzamo2QIDAQAB".split("`");	
            a = C.ALLATORIxDEMO(a6[3]);	
            byte[] a7 = C.ALLATORIxDEMO(a6[1]);	
            String a8 = new String(C.ALLATORIxDEMO(a2, a, a7), "UTF-8");	
            a8 = C.d(a8, "`\n", "\n\n");	
            a8 = C.ALLATORIxDEMO(a8, "\n", "", -1, false);	
            a8 = C.d(C.ALLATORIxDEMO(a8, a6[4]), a6[2]);	
            int a9 = 96;	
            int a10 = 96 + 32;	
            String string = a8;	
            byte[] a11 = C.d(string.substring(a9, a10));	
            a9 = a10;	
            byte[] a12 = C.d(string.substring(a9, a10 += 32));	
            a9 = a10 + 160;	
            a10 = string.length() - 64 - a6[0].length();	
            byte[] a13 = C.d(string.substring(a9, a10));	
            String a14 = new String(C.ALLATORIxDEMO(a13, a11, a12), "UTF-8");	
            ...
            if (!C.ALLATORIxDEMO(a16, 88).equals(a8)) {	
    ...
    private static /* synthetic */ boolean d(CharSequence seq, CharSequence searchSeq) {	
    ...
    private static /* synthetic */ String d(String contentBase64, String privateKeyBase64) throws Exception {	
        int n;	
        PrivateKey a = C.ALLATORIxDEMO(privateKeyBase64);	
        Cipher a2 = Cipher.getInstance("RS+");	
        PrivateKey privateKey = a;	
        a2.init(2, privateKey);	
        int a3 = ((RSAPrivateKey)privateKey).getModulus().bitLength() / 8;	
        byte[][] a4 = C.ALLATORIxDEMO(C.d(C.ALLATORIxDEMO(contentBase64)), a3);	
        ...
        return C.ALLATORIxDEMO(a5.toString());	
    }	
	
    private static /* synthetic */ String ALLATORIxDEMO(String input) {	
        try {	
            return new String(i.ALLATORIxDEMO(input), "UTF-8");	
        }	
    ...
    public static final l.li ALLATORIxDEMO() {	
        ...
        block7 : {	
            ...
            try {	
                ...
                if (a2 != null) {	
                    a.putAll(C.ALLATORIxDEMO((InputStream)a2));	
        ...
        hashMap.putAll(C.ALLATORIxDEMO(hashMap));	
        ...
        if (C.ALLATORIxDEMO((String)a.get("type"), "1", "2", "9")) {	
            a.put("fnCas", "true");	
            a.put("fnJob", "true");	
        }	
        if (C.ALLATORIxDEMO((String)a.get("type"), new String[]{"2", "9"})) {	
            a.put("fnMsg", "true");	
            a.put("fnI18n", "true");	
            a.put("fnSaas", "true");	
        ...
        b.put("loadMessage", ((StringBuilder)a2).toString());	
        ((StringBuilder)a2).append("\r\n");	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r`    公司名称：").append(ALLATORIxDEMO).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(C.a).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r`    机器码是：").append(i.length > 0 ? i[0] : "").append("").toString());	
        return b;	
    }	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if (C.ALLATORIxDEMO(request.getRequestURI(), a3)) {	
                return true;	
            }	
            if ("9".equals(b.get("type"))) {	
                if (ManagementFactory.getRuntimeMXBean().getUptime() / 86400000L > 1L) {	
                    return false;	
                }	
                if (!C.ALLATORIxDEMO((CharSequence)a2, "://127.0.0.1", "://localhost", "://10.", "://172.", "://192.")) {	
                    return false;	
                }	
            }	
            String a4 = (String)b.get("domainOrIp");	
            if (!(C.ALLATORIxDEMO((CharSequence)b.get("type"), (CharSequence)"0") || C.ALLATORIxDEMO((CharSequence)a4) || C.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (C.d(cs, (CharSequence)C.d(a.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    private static /* synthetic */ String ALLATORIxDEMO(String text, String searchString, String replacement, int max, boolean ignoreCase) {	
        ...
        block5 : {	
            int a3;	
            if (C.ALLATORIxDEMO((CharSequence)text) || C.ALLATORIxDEMO((CharSequence)searchString) || replacement == null || max == 0) {	
                return text;	
            }	
            String a4 = text;	
            if (ignoreCase) {	
    ...
    public static final int ALLATORIxDEMO() {	
        ...
        Iterator<Session> iterator2 = iterator = g.getActiveSessions().iterator();	
        while (iterator2.hasNext()) {	
            LoginInfo a2;	
            ...
            if (C.ALLATORIxDEMO((CharSequence)a4)) {	
    ...
    private static /* synthetic */ PrivateKey ALLATORIxDEMO(String privateKey) throws Exception {	
        byte[] a = C.ALLATORIxDEMO(privateKey);	
        PKCS8EncodedKeySpec a2 = new PKCS8EncodedKeySpec(a);	
        return KeyFactory.getInstance("RS+").generatePrivate(a2);	
    }	
    ...
    private static /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs1, CharSequence cs2) {	
        ...
        return C.ALLATORIxDEMO(cs1, (boolean)0, 0, cs2, 0, cs1.length());	
    }	
	
    private static /* synthetic */ byte[] ALLATORIxDEMO(byte[] input, byte[] key, byte[] iv) {	
        try {	
            void a;	
            SecretKeySpec a2 = new SecretKeySpec(key, "+ES");	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            String a3 = "社区版";	
            try {	
                if (!C.ALLATORIxDEMO((CharSequence)info.get("message"))) {	
                    throw new Exception(info.get("message"));	
                }	
                String a4 = info.get("code");	
                if (!C.ALLATORIxDEMO((CharSequence)a4) && C.ALLATORIxDEMO(a4.split(","), i) && !C.ALLATORIxDEMO((CharSequence)C.a) && !C.ALLATORIxDEMO((CharSequence)ALLATORIxDEMO) && C.d(C.a).equals(C.d(info.get("productName"))) && C.d(ALLATORIxDEMO).equals(C.d(info.get("companyName")))) {	
