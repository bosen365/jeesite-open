...
import com.jeesite.modules.gen.service.i;	
...
public final class C {	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (C.d(cs, (CharSequence)C.ALLATORIxDEMO(a.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final l.li ALLATORIxDEMO() {	
        ...
        Object a2;	
        block7 : {	
            long a3 = System.currentTimeMillis() - i.getTime();	
            if (ALLATORIxDEMO.isLoaded() && a3 / 86400000L <= 0L) {	
        ...
        ALLATORIxDEMO.put("loadMessage", ((StringBuilder)a2).toString());	
        ((StringBuilder)a2).append("\r\n");	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    公司名称：").append(J).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(b).append("").toString());	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            String a4 = (String)ALLATORIxDEMO.get("domainOrIp");	
            if (!(C.ALLATORIxDEMO((CharSequence)ALLATORIxDEMO.get("type"), (CharSequence)"0") || C.ALLATORIxDEMO((CharSequence)a4) || C.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(String str, String ... strs) {	
        if (str != null && strs != null) {	
            ...
            while (n3 < n2) {	
                ...
                if (C.ALLATORIxDEMO(str).equals(C.ALLATORIxDEMO(a))) {	
                    return true;	
                }	
                n3 = ++n;	
            }	
        ...
        if (str != null && strs != null) {	
            ...
            while (n3 < n2) {	
                ...
                while (n6 < n5) {	
                    ...
                    if (C.ALLATORIxDEMO(a).equals(C.ALLATORIxDEMO(a2))) {	
                        return true;	
                    }	
                    n6 = ++n4;	
                }	
    ...
    public static final int ALLATORIxDEMO() {	
        ...
        Iterator<Session> iterator2 = iterator = C.a.getActiveSessions().iterator();	
        while (iterator2.hasNext()) {	
            LoginInfo a2;	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!C.ALLATORIxDEMO((CharSequence)a4) && C.ALLATORIxDEMO(a4.split(","), g) && !C.ALLATORIxDEMO((CharSequence)b) && !C.ALLATORIxDEMO((CharSequence)J) && C.ALLATORIxDEMO(b).equals(C.ALLATORIxDEMO(info.get("productName"))) && C.ALLATORIxDEMO(J).equals(C.ALLATORIxDEMO(info.get("companyName")))) {	
    ...
    private static /* synthetic */ String d(String contentBase64, String privateKeyBase64) throws Exception {	
        ...
        byte[][] a4 = C.ALLATORIxDEMO(C.d(C.d(contentBase64)), a3);	
