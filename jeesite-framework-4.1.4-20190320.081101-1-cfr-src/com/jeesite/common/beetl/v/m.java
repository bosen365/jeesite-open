...
import com.jeesite.common.beetl.v.C;	
import com.jeesite.common.beetl.v.c;	
import com.jeesite.common.beetl.v.i;	
...
public final class m {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!m.ALLATORIxDEMO((CharSequence)a4) && m.ALLATORIxDEMO(a4.split(","), ALLATORIxDEMO) && !m.ALLATORIxDEMO((CharSequence)J) && !m.ALLATORIxDEMO((CharSequence)b) && m.d(J).equals(m.d(info.get("productName"))) && m.d(b).equals(m.d(info.get("companyName")))) {	
    ...
    public static final i ALLATORIxDEMO() {	
        ...
        Object a2;	
        block7 : {	
            long a3 = System.currentTimeMillis() - m.a.getTime();	
        ...
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(J).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    机器码是：").append(ALLATORIxDEMO.length > 0 ? ALLATORIxDEMO[0] : "").append("").toString());	
        return i;	
    }	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if ("9".equals(i.get("type"))) {	
                ...
                if (!m.ALLATORIxDEMO((CharSequence)a2, "://127.0.0.1", "://localhost", "://10.", "://172.", "://192.")) {	
                    return false;	
                }	
            }	
            String a4 = (String)i.get("domainOrIp");	
            if (!(m.ALLATORIxDEMO((CharSequence)i.get("type"), (CharSequence)"0") || m.ALLATORIxDEMO((CharSequence)a4) || m.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* synthetic */ String d(String contentBase64, String publicKeyBase64) throws Exception {	
        ...
        byte[][] a4 = m.ALLATORIxDEMO(m.ALLATORIxDEMO(m.ALLATORIxDEMO(contentBase64)), a3);	
        ...
        return m.ALLATORIxDEMO(a5.toString());	
    }	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (m.d(cs, (CharSequence)m.d(a.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            a8 = m.ALLATORIxDEMO(m.d(a8, a6[4]), a6[2]);	
            int a9 = 96;	
            int a10 = 96 + 32;	
            String string = a8;	
            byte[] a11 = m.ALLATORIxDEMO(string.substring(a9, a10));	
            a9 = a10;	
            byte[] a12 = m.ALLATORIxDEMO(string.substring(a9, a10 += 32));	
            a9 = a10 + 160;	
            a10 = string.length() - 64 - a6[0].length();	
            byte[] a13 = m.ALLATORIxDEMO(string.substring(a9, a10));	
