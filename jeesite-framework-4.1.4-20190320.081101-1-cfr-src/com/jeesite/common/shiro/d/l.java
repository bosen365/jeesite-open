...
import com.jeesite.common.shiro.d.m;	
...
public final class l {	
    ...
    private static /* synthetic */ String ALLATORIxDEMO(String text, String searchString, String replacement, int max, boolean ignoreCase) {	
        ...
        block5 : {	
            int a3;	
            if (l.ALLATORIxDEMO((CharSequence)text) || l.ALLATORIxDEMO((CharSequence)searchString) || replacement == null || max == 0) {	
                return text;	
            }	
            String a4 = text;	
            if (ignoreCase) {	
    ...
    private static /* synthetic */ boolean d(CharSequence cs1, CharSequence cs2) {	
        ...
        return l.ALLATORIxDEMO(cs1, (boolean)0, 0, cs2, 0, cs1.length());	
    }	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            String a3 = "社区版";	
            try {	
                if (!l.ALLATORIxDEMO((CharSequence)info.get("messag"))) {	
                    throw new Exception(info.get("message"));	
                }	
                String a4 = info.get("cod");	
                if (!l.ALLATORIxDEMO((CharSequence)a4) && l.ALLATORIxDEMO(a4.split(","), b) && !l.ALLATORIxDEMO((CharSequence)i) && !l.ALLATORIxDEMO((CharSequence)J) && l.d(i).equals(l.d(info.get("productNam"))) && l.d(J).equals(l.d(info.get("companName")))) {	
                    ...
                    String a5 = map.get("expirDat");	
                    if (!"-1".equals(a5)) {	
                        HashMap<String, String> hashMap;	
                        Date a6 = new SimpleDateFormat("yyyy-MM-dd").parse(a5);	
                        long a7 = (a6.getTime() - System.currentTimeMillis()) / 3600000L / 24L;	
                        if (a7 <= 0L) {	
                            throw new Exception(new StringBuilder().insert(0, "您的").append(a3).append("许可，于").append(new SimpleDateFormat("yy年MM月dd日").format(a6)).append("已到期").toString());	
                        }	
                        if (a7 <= 7L) {	
                        ...
                        hashMap.put("titl", new StringBuilder().insert(0, a3).append("（剩余").append(a7).append("天）").toString());	
                    } else {	
                        a.put("titl", a3);	
                ...
                a.put("type", a2);	
                a.put("titl", a3);	
                a.put("messag", new StringBuilder().insert(0, a8.getMessage()).append("，官方网站：http://jeesite.com").toString());	
            }	
        }	
    ...
    private static /* synthetic */ boolean ALLATORIxDEMO(CharSequence seq, CharSequence searchSeq) {	
        ...
        return l.ALLATORIxDEMO(seq, searchSeq, 0) >= 0;	
    }	
	
    private static /* synthetic */ String d(String contentBase64, String publicKeyBase64) throws Exception {	
        int n;	
        PublicKey a = l.ALLATORIxDEMO(publicKeyBase64);	
        Cipher a2 = Cipher.getInstance("RSA");	
        PublicKey publicKey = a;	
        a2.init(2, publicKey);	
        int a3 = ((RSAPublicKey)publicKey).getModulus().bitLength() / 8;	
        byte[][] a4 = l.ALLATORIxDEMO(l.d(l.ALLATORIxDEMO(contentBase64)), a3);	
        ...
        return l.ALLATORIxDEMO(a5.toString());	
    }	
    ...
    public static final int ALLATORIxDEMO() {	
        ...
        com.jeesite.common.mybatis.d.b.L.ALLATORIxDEMO = false;	
        return a.size();	
    }	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            String a8 = new String(l.ALLATORIxDEMO(a2, a, a7), "UTF-8");	
            a8 = l.d(a8, "\n\n", "\n\n");	
            a8 = l.ALLATORIxDEMO(a8, "\n", "", -1, false);	
            a8 = l.ALLATORIxDEMO(l.d(a8, a6[4]), a6[2]);	
            int a9 = 96;	
            int a10 = 96 + 32;	
            String string = a8;	
            byte[] a11 = l.d(string.substring(a9, a10));	
            a9 = a10;	
            byte[] a12 = l.d(string.substring(a9, a10 += 32));	
            a9 = a10 + 160;	
            a10 = string.length() - 64 - a6[0].length();	
            byte[] a13 = l.d(string.substring(a9, a10));	
            String a14 = new String(l.ALLATORIxDEMO(a13, a11, a12), "UTF-8");	
            ...
            if (!l.ALLATORIxDEMO(a16, 88).equals(a8)) {	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        int n;	
        if (l.ALLATORIxDEMO(cs) || searchCharSequences == null || searchCharSequences.length <= 0) {	
            return false;	
        }	
        ...
        while (n3 < n2) {	
            ...
            if (l.ALLATORIxDEMO(cs, (CharSequence)l.d(a.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final C ALLATORIxDEMO() {	
        HashMap<String, String> a;	
        Object a2;	
        block7 : {	
            long a3 = System.currentTimeMillis() - ALLATORIxDEMO.getTime();	
            if (g.ALLATORIxDEMO() && a3 / 86400000L <= 0L) {	
                return g;	
            }	
            ...
            try {	
                ...
                if (a2 != null) {	
                    a.putAll(l.ALLATORIxDEMO((InputStream)a2));	
                ...
                a.put("messag", a4.getMessage());	
            }	
        }	
        HashMap<String, String> hashMap = a;	
        hashMap.putAll(l.ALLATORIxDEMO(hashMap));	
        ...
        if (l.ALLATORIxDEMO((String)a.get("type"), "1", "2", "9")) {	
            a.put("fnCas", "true");	
            a.put("fnJob", "true");	
        }	
        if (l.ALLATORIxDEMO((String)a.get("type"), new String[]{"2", "9"})) {	
            a.put("fnMsg", "true");	
            a.put("fnI18n", "true");	
            a.put("fnSaas", "true");	
        ...
        c.ALLATORIxDEMO();	
        g.ALLATORIxDEMO("loadMessag", ((StringBuilder)a2).toString());	
        ((StringBuilder)a2).append("\r\n");	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    公司名称：").append(J).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(i).append("").toString());	
    ...
    private static /* synthetic */ PublicKey ALLATORIxDEMO(String publicKey) throws Exception {	
        byte[] a = l.ALLATORIxDEMO(publicKey);	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            c.ALLATORIxDEMO(a2, a);	
            String[] a3 = new String[]{a + "/licenc", new StringBuilder().insert(0, a).append("/licence/save").toString()};	
            if (l.ALLATORIxDEMO(request.getRequestURI(), a3)) {	
                return true;	
            }	
            if ("9".equals(g.get("type"))) {	
                if (ManagementFactory.getRuntimeMXBean().getUptime() / 86400000L > 1L) {	
                    return false;	
                }	
                if (!l.ALLATORIxDEMO((CharSequence)a2, "://127D0D0D1", "://localhost", "://10.", "://172.", "://192.")) {	
                    return false;	
                }	
            }	
            String a4 = (String)g.get("domainOrIp");	
            if (!(l.d((CharSequence)g.get("type"), (CharSequence)"0") || l.ALLATORIxDEMO((CharSequence)a4) || l.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10D,://172D,://192D,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* synthetic */ PrivateKey ALLATORIxDEMO(String privateKey) throws Exception {	
        byte[] a = l.ALLATORIxDEMO(privateKey);	
    ...
    private static /* synthetic */ String ALLATORIxDEMO(String contentBase64, String privateKeyBase64) throws Exception {	
        int n;	
        PrivateKey a = l.ALLATORIxDEMO(privateKeyBase64);	
        Cipher a2 = Cipher.getInstance("RSA");	
