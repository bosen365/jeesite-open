...
public class GlobalController extends BaseController {	
   ...
   public String globalJs(String ctx, HttpServletRequest request, Model model) {	
      ...
      a.append((new StringBuilder()).insert(0, "\ttx='").append((String)StringUtils.defaultIfBlank(ctx, a)).append("',").toString());	
      a.append((new StringBuilder()).insert(0, "\ttxPath='").append(a).append("',").toString());	
      ...
      a.append((new StringBuilder()).insert(0, "\ttxStati\t='").append(a).append("/static',").toString());	
   ...
   public String abcdefg(String username, String password, MultipartFile licFile, HttpServletRequest request, HttpServletResponse response) {	
      if (!UserUtils.getUser().isAdmin()) {	
         ...
         BaseAuthorizingRealm.isValidCodeLogin(a.getLoginCode(), (String)null, "su\tcess");	
      }	
      ...
      try {	
         ...
         this.logger.error("Read licence error.", var10);	
      }	
