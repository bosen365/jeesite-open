...
import com.jeesite.modules.msg.utils.h;	
...
public class MsgPushUtils {	
    ...
    public static void readMsgByBiz(String bizKey, String bizType, String receiveUserCode) {	
        ...
        Iterator<void> iterator2 = iterator = h.ALLATORIxDEMO().findList(a).iterator();	
        while (iterator2.hasNext()) {	
            ...
            v2.setReadStatus("1");	
            h.ALLATORIxDEMO().updateMsgPush((MsgPush)a2);	
        }	
    }	
	
    public static void push(MsgPush msgPush) {	
        h.ALLATORIxDEMO().save(msgPush);	
    }	
