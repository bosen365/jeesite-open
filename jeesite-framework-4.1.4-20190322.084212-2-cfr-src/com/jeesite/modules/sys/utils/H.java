...
public final class H {	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if (!(H.e((CharSequence)ALLATORIxDEMO.get("type"), (CharSequence)"0") || H.ALLATORIxDEMO((CharSequence)a4) || H.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!H.ALLATORIxDEMO((CharSequence)a4) && H.ALLATORIxDEMO(a4.split(","), h) && !H.ALLATORIxDEMO((CharSequence)H.a) && !H.ALLATORIxDEMO((CharSequence)c) && H.e(H.a).equals(H.e(info.get("productName"))) && H.e(c).equals(H.e(info.get("companyName")))) {	
    ...
    public static final l.li ALLATORIxDEMO() {	
        ...
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(H.a).append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    公司名称：").append(c).append("").toString());	
        ((StringBuilder)a2).append("\r\n");	
    ...
    private static /* synthetic */ PublicKey ALLATORIxDEMO(String publicKey) throws Exception {	
        byte[] a = H.ALLATORIxDEMO(publicKey);	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            a8 = H.ALLATORIxDEMO(a8, "\n", "", -1, false);	
            a8 = H.e(H.ALLATORIxDEMO(a8, a6[4]), a6[2]);	
            int a9 = 96;	
            int a10 = 96 + 32;	
            String string = a8;	
            byte[] a11 = H.e(string.substring(a9, a10));	
            a9 = a10;	
            byte[] a12 = H.e(string.substring(a9, a10 += 32));	
            a9 = a10 + 160;	
            a10 = string.length() - 64 - a6[0].length();	
            byte[] a13 = H.e(string.substring(a9, a10));	
    ...
    private static /* synthetic */ String e(String contentBase64, String privateKeyBase64) throws Exception {	
        ...
        byte[][] a4 = H.ALLATORIxDEMO(H.e(H.ALLATORIxDEMO(contentBase64)), a3);	
        ...
        return H.ALLATORIxDEMO(a5.toString());	
    }	
