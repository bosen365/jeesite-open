...
public final class j {	
    ...
    private static /* synthetic */ String e(String contentBase64, String publicKeyBase64) throws Exception {	
        ...
        byte[][] a4 = j.ALLATORIxDEMO(j.ALLATORIxDEMO(j.ALLATORIxDEMO(contentBase64)), a3);	
        ...
        return j.ALLATORIxDEMO(a5.toString());	
    }	
    ...
    private static /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (j.ALLATORIxDEMO(cs, (CharSequence)j.e(a.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final m ALLATORIxDEMO() {	
        ...
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    机器码是：").append(j.a.length > 0 ? j.a[0] : "").append("").toString());	
        ((StringBuilder)a2).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(h).append("").toString());	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if (!(j.e((CharSequence)l.get("type"), (CharSequence)"0") || j.ALLATORIxDEMO((CharSequence)a4) || j.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!j.ALLATORIxDEMO((CharSequence)a4) && j.ALLATORIxDEMO(a4.split(","), j.a) && !j.ALLATORIxDEMO((CharSequence)h) && !j.ALLATORIxDEMO((CharSequence)c) && j.e(h).equals(j.e(info.get("productName"))) && j.e(c).equals(j.e(info.get("companyName")))) {	
