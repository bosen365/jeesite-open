    ...
    private /* synthetic */ String getNotifyOptions(RedisConnection connection) {	
        ...
        block3 : {	
            try {	
                ...
                throw new IllegalStateException("Unable to configure Redis to keyspace notifications. See http://docs.spring.io/spring-session/docs/current/reference/html5/#api-redisoperationssessionrepository-sessiondestroyedevent", a2);	
            }	
        }	
