...
public final class j {	
    ...
    public static final int ALLATORIxDEMO() {	
        ...
        if (l == null) {	
            l = SpringUtils.getBean(SessionDAO.class);	
        }	
        HashSet<String> a = new HashSet<String>();	
        I.ALLATORIxDEMO = false;	
        Iterator<Session> iterator2 = iterator = l.getActiveSessions().iterator();	
    ...
    private static /* synthetic */ String e(String contentBase64, String privateKeyBase64) throws Exception {	
        ...
        byte[][] a4 = j.ALLATORIxDEMO(j.e(j.e(contentBase64)), a3);	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!j.ALLATORIxDEMO((CharSequence)a4) && j.ALLATORIxDEMO(a4.split(","), ALLATORIxDEMO) && !j.ALLATORIxDEMO((CharSequence)j.a) && !j.ALLATORIxDEMO((CharSequence)J) && j.ALLATORIxDEMO(j.a).equals(j.ALLATORIxDEMO(info.get("productName"))) && j.ALLATORIxDEMO(J).equals(j.ALLATORIxDEMO(info.get("companyName")))) {	
    ...
    private static /* synthetic */ PublicKey ALLATORIxDEMO(String publicKey) throws Exception {	
        byte[] a = j.ALLATORIxDEMO(publicKey);	
    ...
    private static /* synthetic */ PrivateKey ALLATORIxDEMO(String privateKey) throws Exception {	
        byte[] a = j.ALLATORIxDEMO(privateKey);	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            String[] a6 = ">>>>大牛你好，能否留个联系方式，合作QQ：78112665，暗号：Licence520<<<<`7Km/KZk46sPt7e5xmn6ZIA==`MIICdQIBADANBgkqhkiG9w0BAQEFAASCAl8wgg bAgEAAoGBAMMl5nOBVE+Q sNC+Iti3rxgMbTU8NhptURjxslLFCxm94uFUnKUQ1k9KUgfWH2+RlM8DAz0HSDJX94+Pgsgqw3IO7r2uSIXQcqPDVOxGT/qUaSMdscBYuC42cOdiB5F4cNGf/iPdQm6 ZMBBTjCGRtLel/sCb8lditqoz6MhJfRAgMBAAECg3B/mXSJ6fKa44K1AkFJwqgpPCzENMgWeWgRA7yjOfhC4EDUdaRnTxKKczde9UADWDrbidPHVIcHPST2SHSBCidNgeF/ox+MR72wQRRWl7hjmAUHRGnt8ICiCUpWvz93PTlVORAJwk2wkBv3zBveUdR2oLFeNQ7ARvXlDLQW1ybAEQ BAPeJyC0I/2 G+BlpUzUgjKlOlQpl57KfKdIF1s 9gAuPKk4qHbVftcp6PqQhWEBtzrCsbNlofG77ziSKt4QRfU8CQQDJ0aZK2hO0UqQDPviAqUX5ZC3S4C6CUTBOiPyLw+mLlZBgg+jvyMuMwnxK/m9fK5hfZggQI5Ue3hVIbkstdJDfAkAnlmhmE2dMX080OSzudSsptICPbia04VF93iMvb3S51IaOg5vGsuzO2egEtbR4cVc52Al8Z4 m+WxJWcnpnCZvAkA9Rz3hvmN7Phh0r9sOXddUSPms7MrSYMp1HhzoZxzzd/81fvfsTqCXZboNn0G7uOX0GWvbUqKFk9MMggirjZgrAkB4j5OC07ov3aRS9/hwHgSj8iKAThsADOygDRifXeLTHAAmtHBHdS8lCqIvznAMAMHRa5N2v6h2i59LEE23LO9l`PxXhwSyYKLHQlmcx59Fl6Q==`MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCeP3uA/B0NP8RG3q8zXjmkYrAzcd5IMKbOkDbnwBn5dpwn1Cp0qBSpFKciUtvX3v6+HSoQW9UEVzvhOn0mgsTGArwd5dfVaR11AbPQEfxJjnI649LrjMmw4No+AO+l4LhPWu83Mk4eR4FXMWs4vIh2lmWLTMCy4mGKndsTzamo2QIDAQAB".split("`");	
            a = j.ALLATORIxDEMO(a6[3]);	
            byte[] a7 = j.ALLATORIxDEMO(a6[1]);	
            String a8 = new String(j.ALLATORIxDEMO(a2, a, a7), "UTF-8");	
            a8 = j.e(a8, "\n\n", "\n\n");	
            a8 = j.ALLATORIxDEMO(a8, "\n", "", -1, false);	
            a8 = j.e(j.ALLATORIxDEMO(a8, a6[4]), a6[2]);	
            int a9 = 96;	
            int a10 = 96 + 32;	
            String string = a8;	
            byte[] a11 = j.e(string.substring(a9, a10));	
            a9 = a10;	
            byte[] a12 = j.e(string.substring(a9, a10 += 32));	
            a9 = a10 + 160;	
            a10 = string.length() - 64 - a6[0].length();	
            byte[] a13 = j.e(string.substring(a9, a10));	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if (!(j.e((CharSequence)h.get("type"), (CharSequence)"0") || j.ALLATORIxDEMO((CharSequence)a4) || j.ALLATORIxDEMO((CharSequence)a2, (CharSequence[])(a4 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a4).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    public static final m ALLATORIxDEMO() {	
        ...
        Object a2;	
        block7 : {	
            long a3 = System.currentTimeMillis() - c.getTime();	
