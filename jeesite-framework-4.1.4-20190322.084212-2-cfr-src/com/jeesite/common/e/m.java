...
public class m {	
    ...
    @Autowired	
    private ModuleService c;	
    private static Logger ALLATORIxDEMO = LoggerFactory.getLogger(m.class);	
    ...
    private /* synthetic */ String ALLATORIxDEMO(Module module, String dbVersion) {	
        ...
        if (a2 < 0) {	
            ALLATORIxDEMO.warn(new StringBuilder().insert(0, "自动更新").append(module.getModuleCode()).append("模块的数据库失败，未知的版本号“").append(dbVersion).append("”，可能是数据库版本比代码版本新。").toString());	
            return null;	
        }	
    ...
    private /* synthetic */ void ALLATORIxDEMO() {	
        ...
        if (StringUtils.isBlank(a)) {	
            CacheUtils.put("jeesiteVersion", m.ALLATORIxDEMO());	
        } else if (!StringUtils.equals(a, m.ALLATORIxDEMO())) {	
    ...
    private /* synthetic */ boolean ALLATORIxDEMO(Module module, String currentVersion) {	
        ...
        block25 : {	
            block24 : {	
                ...
                a = new StringBuilder().insert(0, "/db/upgrade/").append(module.getModuleCode()).append("/").append(a5).append("/").append(a5).append("_").append(currentVersion).append(".sql").toString();	
                ...
                ALLATORIxDEMO.info(new StringBuilder().insert(0, "恭喜您").append(module.getModuleCode()).append("模块的数据库已升级完成：{}").toString(), (Object)a);	
                bl = true;	
        ...
        return bl;	
            ...
            return a6;	
                ...
                block29 : {	
                    block28 : {	
                        ALLATORIxDEMO.warn(new StringBuilder().insert(0, "很抱歉").append(module.getModuleCode()).append("模块的数据库升级脚本执行错误：{}").toString(), (Object)a, (Object)a922222222);	
