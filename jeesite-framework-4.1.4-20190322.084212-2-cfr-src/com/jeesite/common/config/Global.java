...
import com.jeesite.common.config.m;	
...
public class Global {	
    ...
    public static void setLang(String lang, HttpServletRequest request, HttpServletResponse response) {	
        ...
        m.ALLATORIxDEMO().setLocale(request, response, a);	
    }	
    ...
    public static String getText(String code, String ... params) {	
        ...
        try {	
            return m.ALLATORIxDEMO().getMessage(code, params, a);	
        }	
    ...
    public static String getProperty(String key) {	
        ...
        if (a == null) {	
            if ("jeesiteVersion".equals(key)) {	
                a = new StringBuilder().insert(0, "V").append(com.jeesite.common.e.m.ALLATORIxDEMO()).toString();	
                props.put(key, a);	
                return a;	
            }	
    ...
    public static Boolean isUseCorpModel() {	
        if (!ObjectUtils.toBoolean(H.ALLATORIxDEMO().get("fnSaas")).booleanValue()) {	
            return false;	
        }	
    ...
    public static void assertDemoMode() {	
        if (ObjectUtils.toBoolean(Global.getProperty("demoMode", FALSE)).booleanValue()) {	
    ...
    public static String getLang() {	
        if (I18nLocaleResolver.enabled()) {	
            ...
            if (a2 != null) {	
                a = m.ALLATORIxDEMO().resolveLocale(a2);	
            }	
            if (a != null) {	
                return a.toString();	
            }	
