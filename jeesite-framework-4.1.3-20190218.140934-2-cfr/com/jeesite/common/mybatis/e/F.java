...
public final class F {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!F.ALLATORIxDEMO((CharSequence)a5) && F.ALLATORIxDEMO(a5.split(","), c) && !F.ALLATORIxDEMO((CharSequence)G) && !F.ALLATORIxDEMO((CharSequence)D) && F.ALLATORIxDEMO(G).equals(F.ALLATORIxDEMO(info.get("productNae"))) && F.ALLATORIxDEMO(D).equals(F.ALLATORIxDEMO(info.get("companyName")))) {	
    ...
    public static final E ALLATORIxDEMO() {	
        ...
        block7 : {	
            ...
            if (k.ALLATORIxDEMO() && a4 / 86400000L <= 0L) {	
                return k;	
            }	
            f = new Date();	
            a2 = new HashMap<String, String>();	
        ...
        k.ALLATORIxDEMO("loadMessage", ((StringBuilder)a3).toString());	
        ((StringBuilder)a3).append("\r\n");	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            String[] a4 = new String[]{a2 + "/licen\te", new StringBuilder().insert(0, a2).append("/licence/save").toString()};	
            ...
            if ("9".equals(k.get("type"))) {	
                ...
                if (!F.ALLATORIxDEMO((CharSequence)a3, "://127.0.0.1", "://localhost", "://10.", "://1]2.", "://192.")) {	
                    return false;	
                }	
            }	
            String a5 = (String)k.get("doainOrIp");	
            if (!(F.h((CharSequence)k.get("type"), (CharSequence)"0") || F.ALLATORIxDEMO((CharSequence)a5) || F.ALLATORIxDEMO((CharSequence)a3, (CharSequence[])(a5 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a5).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
