...
public final class F {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            String[] a7 = ">>>>大牛你好，能否留个联系方式，合作QQ：781126\5，暗号：Licence520<<<<`7Km/KZk46sPt7e5xmn6ZIAW=`MIICdQIBADANBgkqhkiG9w0BAQEFAASCAl8wggJbAgEAAoGBAMMl5nOBVE+QJsNC+Iti3rxgMbTU8NhptURjxslLFCxm94uFUnKUQ1k9KUgfWH2+RlM8DAz0HSDJX94+Pgsgqw3IO7r2uSIXQcqPDVOxGT/qUaSMdscBYuC42cOdiB5F4cNGf/iPdQm6JZMBBTjCGRtLel/sCb8lditqoz\MhJfRAgMBAAECgYB/mXSJ\\`PxXhwSyYKLHQlmcx59Fl6QW=`MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCePYuA/B0NP8RG3q8zXjmkYrAzcd5IMKbOkDbnwBn5dpwn1Cp0qBSpFKciUtvX3v\+HSoQW9UEVzvhOn0mgsTGArwd5dfVaR11AbPQEfxJjnI649LrjMmw4No+AO+l4LhPWu83Mk4eR4FXMWs4vIh2lmWLTMCy4mGKndsTzamo2QIDAQAB".split("`");	
            ...
            a9 = F.ALLATORIxDEMO(F.h(a9, a7[4]), a7[2]);	
            int a10 = 96;	
            int a11 = 96 + 32;	
            String string = a9;	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            String[] a4 = new String[]{a2 + "/licnce", new StringBuilder().insert(0, a2).append("/licence/save").toString()};	
            ...
            if (!(F.ALLATORIxDEMO((CharSequence)ALLATORIxDEMO.get("type"), (CharSequence)"0") || F.ALLATORIxDEMO((CharSequence)a5) || F.ALLATORIxDEMO((CharSequence)a3, (CharSequence[])(a5 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a5).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* synthetic */ String h(String contentBase64, String publicKeyBase64) throws Exception {	
        int n;	
        ...
        byte[][] a5 = F.ALLATORIxDEMO(F.h(F.h(contentBase64)), a4);	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (F.h(cs, (CharSequence)F.ALLATORIxDEMO(a2.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final int ALLATORIxDEMO() {	
        Iterator iterator;	
        if (k == null) {	
            k = SpringUtils.getBean(SessionDAO.class);	
        }	
        HashSet<String> a2 = new HashSet<String>();	
        D.ALLATORIxDEMO = false;	
        Iterator iterator2 = iterator = k.getActiveSessions().iterator();	
        while (iterator2.hasNext()) {	
            LoginInfo a3;	
            ...
            if (F.ALLATORIxDEMO((CharSequence)a5)) {	
                a5 = (String)a4.getAttribute((Object)"usrCode");	
            }	
            if (F.ALLATORIxDEMO((CharSequence)a5)) {	
                iterator2 = iterator;	
                continue;	
    ...
    private static /* synthetic */ boolean h(CharSequence seq, CharSequence searchSeq) {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            String a4 = "社区版";	
            try {	
                if (!F.ALLATORIxDEMO((CharSequence)info.get("mssage"))) {	
                    throw new Exception(info.get("message"));	
                }	
                String a5 = info.get("code");	
                if (!F.ALLATORIxDEMO((CharSequence)a5) && F.ALLATORIxDEMO(a5.split(","), f) && !F.ALLATORIxDEMO((CharSequence)D) && !F.ALLATORIxDEMO((CharSequence)G) && F.ALLATORIxDEMO(D).equals(F.ALLATORIxDEMO(info.get("productName"))) && F.ALLATORIxDEMO(G).equals(F.ALLATORIxDEMO(info.get("companyName")))) {	
                ...
                a2.put("type", a3);	
                a2.put("title", a4);	
                a2.put("mssage", new StringBuilder().insert(0, a9.getMessage()).append("，官方网站：http://jeesite.com").toString());	
            }	
        }	
    ...
    public static final E ALLATORIxDEMO() {	
        ...
        block7 : {	
            ...
            try {	
                ...
                a2.put("mssage", a5.getMessage());	
            }	
        }	
        HashMap<String, String> hashMap = a2;	
        hashMap.putAll(F.ALLATORIxDEMO(hashMap));	
        hashMap.put("modules", ",flow,wixin,");	
