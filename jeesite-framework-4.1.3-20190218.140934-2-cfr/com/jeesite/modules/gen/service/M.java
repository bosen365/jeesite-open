...
public final class M {	
    private static SessionDAO f;	
    private static final String[] G;	
    private static final String k;	
    private static final String D;	
    private static Date c;	
    private static final l.li ALLATORIxDEMO;	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!M.ALLATORIxDEMO((CharSequence)a5) && M.ALLATORIxDEMO(a5.split(","), G) && !M.ALLATORIxDEMO((CharSequence)D) && !M.ALLATORIxDEMO((CharSequence)k) && M.h(D).equals(M.h(info.get("productName"))) && M.h(k).equals(M.h(info.get("companName")))) {	
                    ...
                    if (!"-1".equals(a6)) {	
                        ...
                        Date a7 = new SimpleDateFormat("yyyy-MM-dd").parse(a6);	
                        long a8 = (a7.getTime() - System.currentTimeMillis()) / 3600000L / 24L;	
                        if (a8 <= 0L) {	
                            throw new Exception(new StringBuilder().insert(0, "您的").append(a4).append("许可，于").append(new SimpleDateFormat("yy年MM月dd日").format(a7)).append("已到期").toString());	
                        }	
                        if (a8 <= 7L) {	
                ...
                a2.put("type", a3);	
                a2.put("title", a4);	
                a2.put("message", new StringBuilder().insert(0, a9.getMessage()).append("，官方网站：http://jeesite.com").toString());	
            }	
        }	
    ...
    public static final int ALLATORIxDEMO() {	
        Iterator iterator;	
        if (f == null) {	
            f = SpringUtils.getBean(SessionDAO.class);	
        }	
        HashSet<String> a2 = new HashSet<String>();	
        D.ALLATORIxDEMO = false;	
        Iterator iterator2 = iterator = f.getActiveSessions().iterator();	
        while (iterator2.hasNext()) {	
            ...
            if (M.ALLATORIxDEMO((CharSequence)a5)) {	
    ...
    public static final l.li ALLATORIxDEMO() {	
        ...
        Object a3;	
        block7 : {	
            long a4 = System.currentTimeMillis() - c.getTime();	
            if (ALLATORIxDEMO.isLoaded() && a4 / 86400000L <= 0L) {	
            ...
            try {	
                ...
                if (a3 != null) {	
                    a2.putAll(M.ALLATORIxDEMO((InputStream)a3));	
        ...
        if (M.ALLATORIxDEMO((String)a2.get("type"), "1", "2", "9")) {	
            a2.put("fnCas", "true");	
            a2.put("fnJob", "true");	
        }	
        if (M.ALLATORIxDEMO((String)a2.get("type"), new String[]{"2", "9"})) {	
            a2.put("fnMsg", "true");	
            a2.put("fnI18n", "true");	
            a2.put("fnSaas", "true");	
            a2.put("fnCluster", "true");	
        }	
        ...
        ALLATORIxDEMO.put("loadMessage", ((StringBuilder)a3).toString());	
        ((StringBuilder)a3).append("\r\n");	
        ((StringBuilder)a3).append(new StringBuilder().insert(0, "\r\n    公司名称：").append(k).append("").toString());	
        ((StringBuilder)a3).append(new StringBuilder().insert(0, "\r\n    产品名称：").append(D).append("").toString());	
        ((StringBuilder)a3).append(new StringBuilder().insert(0, "\r\n    机器码是：").append(G.length > 0 ? G[0] : "").append("").toString());	
        return ALLATORIxDEMO;	
    }	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            String[] a7 = ">>>>大牛你好，能否留个联系方式，合作QQ：78112665，暗号：Licence520<<<<`7Km/KZk46sPt7e5xmn6ZIA==``PxXhwSYKLHQlmcx59Fl6Q==`MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCePYuA/B0NP8RG3q8z2jmkYrAzcd5IMKbOkDbnwBn5dpwn1Cp0qBSpFKciUtvX3v6+HSoQW9UEVzvhOn0mgsTGArwd5dfVaR11AbPQEfxJjnI649LrjMmw4No+AO+l4LhPWu83Mk4eR4FXMWs4vIh2lmWLTMC4mGKndsTzamo2QIDAQAB".split("`");	
            a2 = M.ALLATORIxDEMO(a7[3]);	
            byte[] a8 = M.ALLATORIxDEMO(a7[1]);	
            String a9 = new String(M.ALLATORIxDEMO(a3, a2, a8), "UTF-8");	
            a9 = M.h(a9, "\n\n", "\n\n");	
            a9 = M.ALLATORIxDEMO(a9, "\n", "", -1, false);	
            a9 = M.h(M.ALLATORIxDEMO(a9, a7[4]), a7[2]);	
            int a10 = 96;	
            int a11 = 96 + 32;	
            String string = a9;	
            byte[] a12 = M.h(string.substring(a10, a11));	
            a10 = a11;	
            byte[] a13 = M.h(string.substring(a10, a11 += 32));	
            a10 = a11 + 160;	
            a11 = string.length() - 64 - a7[0].length();	
            byte[] a14 = M.h(string.substring(a10, a11));	
            String a15 = new String(M.ALLATORIxDEMO(a14, a12, a13), "UTF-8");	
            ...
            if (!M.ALLATORIxDEMO(a17, 88).equals(a9)) {	
    ...
    private static /* synthetic */ PublicKey ALLATORIxDEMO(String publicKey) throws Exception {	
        byte[] a2 = M.ALLATORIxDEMO(publicKey);	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (M.ALLATORIxDEMO(cs, (CharSequence)M.h(a2.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if (M.ALLATORIxDEMO(request.getRequestURI(), a4)) {	
                return true;	
            }	
            if ("9".equals(ALLATORIxDEMO.get("type"))) {	
                ...
                if (!M.ALLATORIxDEMO((CharSequence)a3, "://127.0.0.1", "://localhost", "://10.", "://172.", "://192.")) {	
                    return false;	
                }	
            }	
            String a5 = (String)ALLATORIxDEMO.get("domainOrIp");	
            if (!(M.h((CharSequence)ALLATORIxDEMO.get("type"), (CharSequence)"0") || M.ALLATORIxDEMO((CharSequence)a5) || M.ALLATORIxDEMO((CharSequence)a3, (CharSequence[])(a5 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a5).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* synthetic */ String h(String contentBase64, String privateKeyBase64) throws Exception {	
        int n;	
        PrivateKey a2 = M.ALLATORIxDEMO(privateKeyBase64);	
        ...
        byte[][] a5 = M.ALLATORIxDEMO(M.h(M.ALLATORIxDEMO(contentBase64)), a4);	
    ...
    private static /* synthetic */ String ALLATORIxDEMO(String contentBase64, String publicKeyBase64) throws Exception {	
        int n;	
        PublicKey a2 = M.ALLATORIxDEMO(publicKeyBase64);	
        Cipher a3 = Cipher.getInstance("RSA");	
