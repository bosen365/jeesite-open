...
public final class M {	
    ...
    public static final Map<String, String> ALLATORIxDEMO(InputStream inputStream) {	
        ...
        try {	
            ...
            a9 = M.ALLATORIxDEMO(M.h(a9, a7[4]), a7[2]);	
            int a10 = 96;	
            int a11 = 96 + 32;	
            String string = a9;	
        ...
        if (str != null && strs != null) {	
            ...
            while (n3 < n2) {	
                ...
                while (n6 < n5) {	
                    ...
                    if (M.ALLATORIxDEMO(a2).equals(M.ALLATORIxDEMO(a3))) {	
                        return true;	
                    }	
                    n6 = ++n4;	
                }	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(String str, String ... strs) {	
        if (str != null && strs != null) {	
            ...
            while (n3 < n2) {	
                String a2 = arrstring[n];	
                if (M.ALLATORIxDEMO(str).equals(M.ALLATORIxDEMO(a2))) {	
                    return true;	
                }	
                n3 = ++n;	
            }	
    ...
    public static final boolean ALLATORIxDEMO(HttpServletRequest request) {	
        ...
        if (request != null) {	
            ...
            if ("9".equals(c.get("type"))) {	
                if (ManagementFactory.getRuntimeMXBean().getUptime() / 86400000L > 1L) {	
                    return false;	
                }	
                if (!M.ALLATORIxDEMO((CharSequence)a3, "://12].0.0.1", "://localhost", "://10.", "://172.", "://192.")) {	
                    return false;	
                }	
            }	
            String a5 = (String)c.get("domainOrIp");	
            if (!(M.h((CharSequence)c.get("type"), (CharSequence)"0") || M.ALLATORIxDEMO((CharSequence)a5) || M.ALLATORIxDEMO((CharSequence)a3, (CharSequence[])(a5 = new StringBuilder().insert(0, "://127.0.0.1,://localhost,://10.,://172.,://192.,").append(a5).toString()).split(",")))) {	
                return false;	
            }	
        }	
        return true;	
    ...
    private static /* synthetic */ String h(String contentBase64, String publicKeyBase64) throws Exception {	
        ...
        byte[][] a5 = M.ALLATORIxDEMO(M.h(M.h(contentBase64)), a4);	
    ...
    public static final int ALLATORIxDEMO() {	
        ...
        Iterator iterator2 = iterator = ALLATORIxDEMO.getActiveSessions().iterator();	
        while (iterator2.hasNext()) {	
            LoginInfo a3;	
    ...
    private static /* varargs */ /* synthetic */ boolean ALLATORIxDEMO(CharSequence cs, CharSequence ... searchCharSequences) {	
        ...
        while (n3 < n2) {	
            ...
            if (M.ALLATORIxDEMO(cs, (CharSequence)M.ALLATORIxDEMO(a2.toString()))) {	
                return true;	
            }	
            n3 = ++n;	
        }	
    ...
    public static final Map<String, String> ALLATORIxDEMO(Map<String, String> info) {	
        ...
        block17 : {	
            ...
            try {	
                ...
                if (!M.ALLATORIxDEMO((CharSequence)a5) && M.ALLATORIxDEMO(a5.split(","), D) && !M.ALLATORIxDEMO((CharSequence)G) && !M.ALLATORIxDEMO((CharSequence)k) && M.ALLATORIxDEMO(G).equals(M.ALLATORIxDEMO(info.get("productNae"))) && M.ALLATORIxDEMO(k).equals(M.ALLATORIxDEMO(info.get("companyName")))) {	
    ...
    public static final l.li ALLATORIxDEMO() {	
        ...
        Object a3;	
        block7 : {	
            long a4 = System.currentTimeMillis() - f.getTime();	
            if (c.isLoaded() && a4 / 86400000L <= 0L) {	
                return c;	
            }	
            f = new Date();	
            a2 = new HashMap<String, String>();	
        ...
        c.put("loadMessage", ((StringBuilder)a3).toString());	
        ((StringBuilder)a3).append("\r\n");	
